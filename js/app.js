...
function getFoodHtml ( cat, icon, name, rating, edit = true ) {
	var food = '<div class="food" data-cat="'+cat+'"><div class="icon"><img src="'+iconUrl+iconNames[icon]+'"></div><div class="food-side"><div class="food-name"><span>'+name+'</span></div><div class="food-rating"><i data-star="'+rating+'"></i></div>';
...
for (let i = 0; i < json['foods'].length; i++) {
	...
	foodList.append(getFoodHtml(currentFood.cat, currentFood.icon, currentFood.name, currentFood.rating));
}
